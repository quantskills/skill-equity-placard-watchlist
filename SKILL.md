...
> **一句话**：单一股东持股达到 5% 时，《证券法》要求其公开披露身份与持股——即"举牌"。
> 本工具从十大股东快照重建这类事件，回答**谁在举牌、举到第几档、意在价差还是控制权**。
> **口径：报告期快照重建，非实时举牌播报。**
...
- **首次举牌**（上穿 5%）→ 新的重要股东进场
- **继续加码**（上穿 10/15/20/25/30%）→ 档位越高越接近谋求控制权；30% 是要约收购分水岭
- **减持跌破** → 此前的举牌头寸在退出
- **逼近观察** → 已到 4.x%，再增持少量即触发披露
...
| **股本变动被动稀释** | 公司增发后总股本增加，未交易股东占比同步下降。实测 301629.SZ 七个股东比值全是 0.75000、600358.SH 六个股东全是 0.4341——不处理会**全部误报成"减持跌破举牌线"** | 按 (票,报告期) 推断股本变动系数 k，只认**交易造成的**越线 |
